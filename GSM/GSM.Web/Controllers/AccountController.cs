namespace GSM.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		public ActionResult Login(string returnUrl)
		{
			...
			ViewBag.Header = ConfigurationManager.AppSettings["LoginPageHeader"];
			return View();
		}
		...
		public ActionResult Login(LoginViewModel model, string returnUrl)
		{
			...
			var result = SignInManager.PasswordSignInAsync(model.UserName, model.Password, model.RememberMe,
				shouldLockout: false);
