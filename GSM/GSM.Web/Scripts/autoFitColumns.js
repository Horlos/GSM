...
/***/ function(module, exports, __webpack_require__) {
	...
	var UiGridAutoFitColumnsService = (function () {
	    ...
	    UiGridAutoFitColumnsService.prototype.columnsProcessor = function (renderedColumnsToProcess, rows) {
	        ...
	        var optimalWidths = {};
	        var extraSpace = 15;
	        var gridWidth = renderedColumnsToProcess[0].grid.gridWidth;
	        var visibleColumnsCount = renderedColumnsToProcess.filter(function (column) {
	            return column.visible;
	        }).length;
	        var proportionalWidth = gridWidth / visibleColumnsCount - extraSpace;
	        renderedColumnsToProcess.forEach(function (column) {
	            if (column.colDef.enableColumnAutoFit) {
	                ...
	                if (proportionalWidth > optimalWidths[columnKey_1]) {
	                    optimalWidths[columnKey_1] = proportionalWidth;
	                }
