namespace App.Species.Controllers {
	...
	interface ISpeciesScope extends ng.IScope {
	...
	class SpeciesCtrl {
		...
		static $inject = ['$scope', '$timeout', '$location', 'speciesService', 'userSettingsService'];
		constructor(
			private $scope: ISpeciesScope,
